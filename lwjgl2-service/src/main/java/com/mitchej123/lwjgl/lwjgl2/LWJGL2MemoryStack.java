...
/**
 * Wrapper around GTNHLib's MemoryStack to implement the celeritas abstract MemoryStack.
 */
public class LWJGL2MemoryStack extends MemoryStack {
    private final com.gtnewhorizon.gtnhlib.bytebuf.MemoryStack delegate;

    public LWJGL2MemoryStack(com.gtnewhorizon.gtnhlib.bytebuf.MemoryStack delegate) {
