package org.embeddedt.embeddium.api.compat.mc;
...
public interface MinecraftVersionShimService {
    MinecraftVersionShimService MINECRAFT = ServiceLoader.load(MinecraftVersionShimService.class).findFirst().orElseThrow();
    ...
    void bindMainFramebufferWrite(boolean clearError);
