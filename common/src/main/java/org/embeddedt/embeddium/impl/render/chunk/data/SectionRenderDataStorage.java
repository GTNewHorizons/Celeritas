...
public class SectionRenderDataStorage {
     ...
     * <p>
     * Row {@code i} begins {@code i * stride} bytes in. Exposed so that draw-command assembly can hoist the base and
     * stride out of its loop rather than dispatching through {@link #getDataPointer} once per section.
     */
