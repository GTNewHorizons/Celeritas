package org.embeddedt.embeddium.impl.compat.mc;
...
import org.embeddedt.embeddium.api.compat.mc.MinecraftVersionShimService;
...
public class ModernMinecraftVersionShim implements MinecraftVersionShimService {
    ...
    public static final String backupVersionNumber = "1.20.3";
    ...
    @Override
    public int getDepthBufferVersion() {
        return ((Blaze3dRenderTargetExt) Minecraft.getInstance().getMainRenderTarget()).iris$getDepthBufferVersion();
    }
    ...
    // Simple options/settings without complex types
    @Override
    public boolean getBobView() {
        return Minecraft.getInstance().options.bobView().get();
    }
    ...
    @Override
    public void bindMainFramebufferWrite(boolean clearError) {
        Minecraft.getInstance().getMainRenderTarget().bindWrite(clearError);
    }
}
